...
fetch('https://api.openweathermap.org/data/2.5/forecast?&id=5604473&units=imperial&APPID=351d4307eb914824188aee15570c17f5')
    ...
    .then((jsObject) => {
        ...
        for (let i = 0; i < (jsObject.list.length); i++) {
            ...
            if (text[1] == '18:00:00'){
                var imagesrc = 'https://openweathermap.org/img/w/' + jsObject[i].weather[0].icon + '@2x.png';
                var desc = jsObject[i].weather[0].description;
                ...
                document.getElementById('temp'+count.toString()).textContent = jsObject[i].main.temp;
                count ++
            }}  
    });
